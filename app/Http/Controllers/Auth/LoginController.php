    ...
    */
    ...
    protected function attemptLogin(Request $request)
    {
        ...
        if(Adldap::auth()->attempt($userdn, $password, $bindAsUser = true)) {
            ...
            // Check if this user is a member of the LDAP group allowed to sign in
            // [I want access ] if(!self::checkMemberOfGroup($username)) return false;
    ...
    protected function checkMemberOfGroup($username) {
        ...
        $ldap_attr = self::accessProtected($ldapuser, 'attributes');
        if(null !== env('LDAP_MEMBER_GROUP')) {
            if(in_array(env('LDAP_MEMBER_GROUP'), $ldap_attr['memberof'])) {
                return true;
            } else {
                return false;
            }
